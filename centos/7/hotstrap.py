...
def configurate():
    ...
    for file in file_list:
        ...
        print('hotstrapper-master/centos/7/' + file + '\t->\t' + '/' + file)
        shutil.move('hotstrapper-master/centos/7/' + file, '/' + file)
    for i in range(3):
...
def jiggle_some_things():
    ...
    subprocess.call('hotstrapper-master/centos/7/start_config_agent.sh')
